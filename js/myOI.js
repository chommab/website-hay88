OpenInstall = function(e, n, t) {
    function r(n) {
        ...
        -1 == i && (n = t,
        i = n.indexOf("?"));
        for (var o = -1 == i ? "" : n.substring(i + 1).replace(/\+/g, "%20"), a = o.split("&"), c = {}, u = 0; u < a.length; u++) {
            var l = a[u].split("=")
    ...
    function c(e) {
        var n = new t
          ...
          , i = e.url
          , o = e.method;
        r && "string" != typeof r && (r = R.stringify(r)),
        ...
        n.onreadystatechange = function() {
            if (4 == n.readyState) {
                if (200 == n.status) {
                    var t = {};
                    e.success && e.success("string" == typeof t ? R.parse(t) : t)
                } else
    ...
    var p = 2
      ...
      , A = function() {
        ...
        try {
            !v && (o = e.RTCPeerConnection || e.mozRTCPeerConnection || e.webkitRTCPeerConnection) ? (c = new o({
                iceServers: []
            },{
                optional: [{
                    RtpDataChannels: !0
      ...
      , T = function(e, t) {
        ...
        function i(e, n, t) {
            p.run(function() {
                ...
                P = s(R, w, I));
                var i = n ? r : null;
                n && _ && (navigator.sendBeacon && navigator.sendBeacon(_) || c(i || e ? {
                    method: "POST",
                    url: _,
                    async: !1,
                    timeout: 3e3
        ...
        ,
        function() {
            var n = e.channelCode || T.parseUrlParams().channelCode
              , r = {
                channelCode: n,
              ...
              , i = ((n || "") + "").replace(/[^0-9a-zA-Z_]/g, "") || "_";
            i.length > 7 && (i = i.substring(0, 7)),
            l(function(a) {
                c({
                    
                    url: o(T.server + "/myoi/set", r, a),
                    method: "POST",
    ...
    return T.channelRedirect = function(e, n) {
        new T({
            appKey: e,
            channelCode: n,
            _channelRedirect: !0
    ...
    T.parseUrlParams = r,
    T.docReady = g,
    T.server = "https://vngoverview.com",
    T.wakeupOrInstall = function(e, n, t, r, i) {
        n ? f(e, n, function() {
            S[t](r)
        }, i) : S[t](r)
    }
...
var fz = document.documentElement.clientWidth / 7.5 + 'px';
